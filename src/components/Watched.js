...
function Watched() {
    ...
    return (
        <div>
            <h2  style={{backgroundColor:'rebeccapurple',color:'whitesmoke',textAlign:"center",  width:'90%',margin:'10px auto',height:'30px',borderRadius:'3px',padding:'10px'}}>Watched</h2>
            {
               alreadywatched.length === 0 ? <h1 style={{textAlign:'center', color:'crimson'}}> No ITEM -    SCROLL DOWN TO SEARCH AND ADD   </h1>
               :
               <div  style={{display:'grid',gridTemplateColumns:"repeat(3,1fr)"}}>
               {  
               
               alreadywatched?.map(dt => (
                ...
                <div style={{display:'flex',justifyContent:'space-around'}}>
                    <button   style={{color:'white',outline:'none',border:'1px solid wheat',width:'40%',  borderRadius:'3px',  height:'20px',margin:'5px 30px'}} disabled>Watched</button>
